...
export const mockComments: CommentItem[] = [
  ...
  },
  {
    ...
    text: 'Praeterea. ex culpa non invenies unum',
    timeAgo: '2h',
    likes: 234,
    repliesCount: 3,
    parentId: null,
  ...
  },
  {
    ...
    text: 'Great presentation! The data visualization was particularly impressive.',
    timeAgo: '5h',
    likes: 567,
    repliesCount: 12,
    parentId: null,
  ...
  },
  {
    ...
    text: 'Could you elaborate more on the Q3 projections?',
    timeAgo: '8h',
    likes: 89,
    repliesCount: 4,
    parentId: null,
  ...
  },
  {
    ...
    text: 'Excellent work on the executive summary. Clear and concise.',
    timeAgo: '12h',
    likes: 445,
    repliesCount: 2,
    parentId: null,
  ...
  },
  {
    ...
    text: 'The financial breakdown section was very thorough. Well done!',
    timeAgo: '1d',
    likes: 312,
    repliesCount: 0,
    parentId: null,
  ...
  },
  {
    ...
    text: 'Looking forward to the Q4 strategy presentation.',
    timeAgo: '2d',
    likes: 678,
    repliesCount: 8,
    parentId: null,
  ...
  },
  {
    ...
    text: 'The methodology section could benefit from more detail on the data sources.',
    timeAgo: '3d',
    likes: 123,
    repliesCount: 1,
    parentId: null,
