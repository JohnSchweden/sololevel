...
jest.mock('@tamagui/lucide-icons', () => {
  ...
  return {
    Menu: React.forwardRef((props: any, ref: React.Ref<SVGElement>) =>
    ...
    Bell: React.forwardRef((props: any, ref: React.Ref<SVGElement>) =>
      React.createElement('svg', {
        ...props,
        ref,
    ...
    BarChart3: ({ size, color, ...props }: any) =>
      React.createElement('svg', {
        ...props,
    ...
    ChevronLeft: ({ size, color, ...props }: any) =>
      React.createElement('svg', {
        ...props,
    ...
    AlertTriangle: ({ size, color, ...props }: any) =>
      React.createElement('svg', {
        ...props,
    ...
    RotateCcw: ({ size, color, ...props }: any) =>
      React.createElement('svg', {
        ...props,
    ...
    SwitchCamera: ({ size, color, ...props }: any) =>
      React.createElement('svg', {
        ...props,
