...
-- Storage policies: Drop existing policies if they exist (for idempotent migrations)
DROP POLICY IF EXISTS "Public read access for thumbnails" ON "storage"."objects";
DROP POLICY IF EXISTS "Service role can manage processed files" ON "storage"."objects";
DROP POLICY IF EXISTS "Service role can manage raw files" ON "storage"."objects";
DROP POLICY IF EXISTS "Service role can manage thumbnails" ON "storage"."objects";
DROP POLICY IF EXISTS "Users can manage own raw files" ON "storage"."objects";
DROP POLICY IF EXISTS "Users can read own processed files" ON "storage"."objects";
DROP POLICY IF EXISTS "Users can upload thumbnails to own folder" ON "storage"."objects";
DROP POLICY IF EXISTS "Users can upload to own raw folder" ON "storage"."objects";
...
CREATE POLICY "Service role can manage processed files" ON "storage"."objects" TO "service_role" USING (("bucket_id" = 'processed'::"text")) WITH CHECK (("bucket_id" = 'processed'::"text"));



CREATE POLICY "Service role can manage raw files" ON "storage"."objects" TO "service_role" USING (("bucket_id" = 'raw'::"text")) WITH CHECK (("bucket_id" = 'raw'::"text"));



CREATE POLICY "Service role can manage thumbnails" ON "storage"."objects" TO "service_role" USING (("bucket_id" = 'thumbnails'::"text")) WITH CHECK (("bucket_id" = 'thumbnails'::"text"));



CREATE POLICY "Users can manage own raw files" ON "storage"."objects" TO "authenticated" USING ((("bucket_id" = 'raw'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (COALESCE(("storage"."foldername"("name"))[1], ''::"text") = ("auth"."uid"())::"text"))) WITH CHECK ((("bucket_id" = 'raw'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (COALESCE(("storage"."foldername"("name"))[1], ''::"text") = ("auth"."uid"())::"text")));



CREATE POLICY "Users can read own processed files" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'processed'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (COALESCE(("storage"."foldername"("name"))[1], ''::"text") = ("auth"."uid"())::"text")));



CREATE POLICY "Users can upload thumbnails to own folder" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'thumbnails'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (COALESCE(("storage"."foldername"("name"))[1], ''::"text") = ("auth"."uid"())::"text")));



CREATE POLICY "Users can upload to own raw folder" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'raw'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (COALESCE(("storage"."foldername"("name"))[1], ''::"text") = ("auth"."uid"())::"text")));
...
GRANT ALL ON FUNCTION "public"."finalize_video_on_raw_object"() TO "anon";
GRANT ALL ON FUNCTION "public"."finalize_video_on_raw_object"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."finalize_video_on_raw_object"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."store_analysis_results"("p_job_id" bigint, "p_full_feedback_text" "text", "p_summary_text" "text", "p_raw_generated_text" "text", "p_full_feedback_json" "jsonb", "p_feedback_prompt" "text", "p_title" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."store_analysis_results"("p_job_id" bigint, "p_full_feedback_text" "text", "p_summary_text" "text", "p_raw_generated_text" "text", "p_full_feedback_json" "jsonb", "p_feedback_prompt" "text", "p_title" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."store_analysis_results"("p_job_id" bigint, "p_full_feedback_text" "text", "p_summary_text" "text", "p_raw_generated_text" "text", "p_full_feedback_json" "jsonb", "p_feedback_prompt" "text", "p_title" "text") TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analyses" TO "anon";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_audio_segments" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_audio_segments" TO "authenticated";
GRANT ALL ON TABLE "public"."analysis_audio_segments" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_audio_segments_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_audio_segments_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_feedback" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_feedback" TO "authenticated";
GRANT ALL ON TABLE "public"."analysis_feedback" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_feedback_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_feedback_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_jobs" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_jobs" TO "authenticated";
GRANT ALL ON TABLE "public"."analysis_jobs" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_jobs_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_jobs_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_metrics" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_metrics" TO "authenticated";
GRANT ALL ON TABLE "public"."analysis_metrics" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_metrics_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_metrics_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_ssml_segments" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."analysis_ssml_segments" TO "authenticated";
GRANT ALL ON TABLE "public"."analysis_ssml_segments" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_ssml_segments_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."analysis_ssml_segments_id_seq" TO "authenticated";
...
GRANT SELECT,USAGE ON SEQUENCE "public"."profiles_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."profiles_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."upload_sessions" TO "anon";
...
GRANT SELECT,USAGE ON SEQUENCE "public"."upload_sessions_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."upload_sessions_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_feedback" TO "anon";
GRANT ALL ON TABLE "public"."user_feedback" TO "authenticated";
GRANT ALL ON TABLE "public"."user_feedback" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."user_feedback_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."user_feedback_id_seq" TO "authenticated";
GRANT SELECT,USAGE ON SEQUENCE "public"."user_feedback_id_seq" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."video_recordings" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."video_recordings" TO "authenticated";
GRANT ALL ON TABLE "public"."video_recordings" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."video_recordings_id_seq" TO "anon";
GRANT SELECT,USAGE ON SEQUENCE "public"."video_recordings_id_seq" TO "authenticated";
...
-- =============================================================================
-- Storage Buckets (raw, processed, thumbnails)
-- These bucket records tell Supabase Storage which buckets exist.
-- The bucket tables themselves are managed by Supabase.
-- =============================================================================
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES 
  ('raw', 'raw', false, 524288000, ARRAY['video/mp4', 'video/quicktime']),
  ('processed', 'processed', false, 104857600, ARRAY['audio/mpeg', 'audio/wav', 'audio/x-wav', 'audio/wave']),
