 ...
 */
export const MOCK_TTS_AUDIO_BYTES = new Uint8Array([
...
/**
 * Get mock TTS result for testing
 */
export function getMockTTSResult(): { bytes: Uint8Array; contentType: string; prompt: string } {
  return {
    bytes: MOCK_TTS_AUDIO_BYTES,
    contentType: 'audio/mpeg',
    prompt: 'Mock TTS synthesis for testing'
  }
}
