...
const TAB_ROUTES = {
  ...
  record: '/(tabs)/record' as const,
  insights: '/(tabs)/insights' as const,
} satisfies Record<'coach' | 'record' | 'insights', string>

// Helper to safely convert tab to Href for router
function getTabHref(tab: 'coach' | 'record' | 'insights'): Href {
  return TAB_ROUTES[tab] as Href
}
